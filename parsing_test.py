...
try:
    ...
    if os.path.exists(pdf_path):
        ...
        if document_result.pages:
            ...
            text_preview = first_page.content.text[:200] if first_page.content.text else "No text extracted"
            print(f"   - Text Preview: {text_preview}...")
            
            # Show headings if any
            if first_page.content.headings:
                print(f"   - Headings on first page: {len(first_page.content.headings)}")
...
""".strip()
        ...
        try:
            ...
            print(f"📝 Preview of summary (first 300 chars):")
        ...
        print("💡 Please place a PDF file named 'sample-local-pdf.pdf' in the 'sample_files/' directory")
...
try:
    ...
    if os.path.exists(csv_path):
        ...
        if document_result.pages:
            ...
            csv_preview = first_section.content.text[:300] if first_section.content.text else "No data extracted"
        ...
        try:
            ...
            print(f"📝 Preview of CSV summary (first 300 chars):")
            print(summary_result[:300] + "...")
        ...
        try:
            ...
            print(f"📊 Template report preview:")
        ...
        print("💡 Please place a CSV file named 'customers-100.csv' in the 'sample_files/' directory")
